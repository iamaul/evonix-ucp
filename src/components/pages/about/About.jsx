                    ...
                    <Grid.Row>
                        ...
                        <Grid.Column width={12}>
                            <p style={{ textAlign: 'justify' }}>
                                EvoniX merupakan komunitas gaming bagi pecinta konten Grand The Auto: San Andreas dimana kami memfokuskan komunitas San Andreas Multiplayer (SA-MP). EvoniX didirikan pada tahun 2018, namun <i>project</i> ini sempat terhambat dikarenakan kesibukan para <i>Staff</i> dan <i>Developers</i>.
